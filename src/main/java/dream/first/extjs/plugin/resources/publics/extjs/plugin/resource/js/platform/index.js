...
var API = {
		//getModule : "http://192.168.0.197:12510/module/getModuleTree",
		getModuleTree : ModuleServiceInterface.getModuleTree,
		//queryModule : "http://192.168.0.197:12510/module/query",
	...
	Co.request(API.getModule, null, function(result, opts){
		...
		if (rootModules) {
			...
			for (var i = 0; i < rootModules.length; i++) {
				...
				var getModuleUrl = API.getModuleTree + "?recursion=true&autoExpand=true&parentModuleNo=" + module.extraParam3;
				//添加token
